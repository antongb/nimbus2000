...
ActiveRecord::Schema.define(version: 20150112230220) do
  ...
  add_index "taggings", ["tag_id", "track_id"], name: "index_taggings_on_tag_id_and_track_id", unique: true, using: :btree
